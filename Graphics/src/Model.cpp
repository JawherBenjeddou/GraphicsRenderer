...
void Model::SetVertexBoneDataToDefault(VertexInfo& vertex)
{
...
void Model::SetVertexBoneData(VertexInfo& vertex, int boneID, float weight)
{
    for (int i = 0; i < MAX_BONE_WEIGHTS; ++i)
    {
...
//
//void Model::ExtractBoneWeightForVertices(std::vector<BoneInfo>& vertices, aiMesh* mesh, const aiScene* scene)
//{
